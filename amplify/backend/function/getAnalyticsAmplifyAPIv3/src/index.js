...
const GRAPHQL_ENDPOINT = "https://aeurd6fuufhb3cmvmy3fuqba5e.appsync-api.ca-central-1.amazonaws.com/graphql";
const GRAPHQL_API_KEY = "da2-lv5r57yrv5h7je4ox6wjtxtbkm";
...
exports.handler = async (event) => {
    ...
    console.log("The hourlydata before parsing is:", hourlyData);
    let hourlyDataParsed = JSON.parse(hourlyData);
    console.log("The hourly data after parsing is:", hourlyDataParsed);
    ...
    console.log("The total realTime data is:", realTime);
