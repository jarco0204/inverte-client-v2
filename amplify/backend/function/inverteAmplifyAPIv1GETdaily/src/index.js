...
exports.handler = async (event) => {
    ...
    let key = event.queryStringParameters.dayOfYear + "_" + event.queryStringParameters.hourOfDay + "_" + event.pathParameters.iotNameThing;
    const params = {
        TableName: "inverte_portionEvents_v6",
