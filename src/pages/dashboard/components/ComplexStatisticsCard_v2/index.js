...
import ReportsLineChartV2 from "../ReportsLineChart_v2";

function ComplexStatisticsCard_v2({ color, title, count, icon, realTimeData }) {
...
ComplexStatisticsCard_v2.defaultProps = {
    color: "info",
    percentage: {
        color: "success",
        text: "",
...
ComplexStatisticsCard_v2.propTypes = {
...
export default ComplexStatisticsCard_v2;
