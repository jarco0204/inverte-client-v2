...
export const listYears = /* GraphQL */ `
  query ListYears(
    ...
    listYears(
      year_iotNameThing: $year_iotNameThing
      filter: $filter
      limit: $limit
      nextToken: $nextToken
      sortDirection: $sortDirection
...
export const listMonths = /* GraphQL */ `
  query ListMonths(
    ...
    listMonths(
      monthOfYear_iotNameThing: $monthOfYear_iotNameThing
      filter: $filter
      limit: $limit
      nextToken: $nextToken
      sortDirection: $sortDirection
...
`;
export const getPortionEvent = /* GraphQL */ `
  query GetPortionEvent($timestamp: ID!) {
    getPortionEvent(timestamp: $timestamp) {
      iotNameThing
      timestamp
      batchPortionID
      inventoryWeight
...
`;
export const listPortionEvents = /* GraphQL */ `
  query ListPortionEvents(
    $timestamp: ID
    $filter: ModelPortionEventFilterInput
    $limit: Int
    $nextToken: String
    $sortDirection: ModelSortDirection
  ) {
...
export const monthsByYear_iotNameThing = /* GraphQL */ `
  query MonthsByYear_iotNameThing(
    $year_iotNameThing: ID!
    $sortDirection: ModelSortDirection
    $filter: ModelMonthFilterInput
    $limit: Int
...
export const weeksByMonthOfYear_iotNameThing = /* GraphQL */ `
  query WeeksByMonthOfYear_iotNameThing(
    $monthOfYear_iotNameThing: ID!
    $sortDirection: ModelSortDirection
    $filter: ModelWeekFilterInput
    $limit: Int
    ...
    weeksByMonthOfYear_iotNameThing(
      monthOfYear_iotNameThing: $monthOfYear_iotNameThing
      sortDirection: $sortDirection
      filter: $filter
      limit: $limit
...
`;
export const portionEventsByDayOfYear_hourOfDay_iotNameThing = /* GraphQL */ `
  query PortionEventsByDayOfYear_hourOfDay_iotNameThing(
    $dayOfYear_hourOfDay_iotNameThing: ID!
    $sortDirection: ModelSortDirection
    $filter: ModelPortionEventFilterInput
    $limit: Int
    ...
    portionEventsByDayOfYear_hourOfDay_iotNameThing(
      dayOfYear_hourOfDay_iotNameThing: $dayOfYear_hourOfDay_iotNameThing
      sortDirection: $sortDirection
      filter: $filter
      limit: $limit
