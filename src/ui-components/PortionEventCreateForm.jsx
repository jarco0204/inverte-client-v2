...
import { createPortionEvent } from "../graphql/mutations";
export default function PortionEventCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setBatchPortionID(initialValues.batchPortionID);
    setInventoryWeight(initialValues.inventoryWeight);
    setBatchPortionWeightAR(initialValues.batchPortionWeightAR);
    setBatchPortionStatusAR(initialValues.batchPortionStatusAR);
    setIngredientName(initialValues.ingredientName);
    setLowerErrorLimit(initialValues.lowerErrorLimit);
    setUpperErrorLimit(initialValues.upperErrorLimit);
    setCorrectWeight(initialValues.correctWeight);
    setPortionTimeTaken(initialValues.portionTimeTaken);
    setWeightClassification(initialValues.weightClassification);
    setTimeClassification(initialValues.timeClassification);
    setErrors({});
  };
  const validations = {
    iotNameThing: [],
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "PortionEventCreateForm")}
      {...rest}
    >
      <TextField
